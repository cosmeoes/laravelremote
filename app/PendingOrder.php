...
class PendingOrder
{
    ...
    protected function createJobPost()
    {
        $job = JobPost::create([
            ...
            'salary_min' => $this->options['salary_min'] ?? 0,
            'salary_max' => $this->options['salary_max'] ?? 0,
            'salary_currency' => $this->options['salary_currency'] ?? "USD",
            'salary_unit' => $this->options['salary_unit'] ?? "year",
